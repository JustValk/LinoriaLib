...
local ThemeManager = {} do
	ThemeManager.Folder = 'AWSThemeSettings'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"#1e1e1e","AccentColor":"#483e52","BackgroundColor":"#191919","OutlineColor":"#292929"}') },
